...
import dev.komrd.core.designsystem.components.NavigationBarDefaults.NavigationBarHeight
import dev.komrd.core.designsystem.components.NavigationBarItemDefaults.ItemAnimationDurationMillis
import dev.komrd.core.designsystem.components.NavigationBarItemDefaults.NavigationBarItemHorizontalPadding
import dev.komrd.core.designsystem.components.NavigationBarItemDefaults.NavigationBarItemVerticalPadding
import dev.komrd.core.designsystem.contentColorFor
import dev.komrd.core.designsystem.foundation.ProvideTextStyle
...
internal object NavigationBarDefaults {
    ...
    val containerColor: Color @Composable get() = KomrdTheme.colors.background
...
object NavigationBarItemDefaults {
    ...
    @Composable
    fun colors(
        selectedIconColor: Color = KomrdTheme.colors.onBackground,
        selectedTextColor: Color = KomrdTheme.colors.onBackground,
        unselectedIconColor: Color = KomrdTheme.colors.onBackground.copy(alpha = 0.65f),
        unselectedTextColor: Color = KomrdTheme.colors.onBackground.copy(alpha = 0.65f),
        disabledIconColor: Color = KomrdTheme.colors.onBackground.copy(alpha = 0.3f),
        disabledTextColor: Color = KomrdTheme.colors.onBackground.copy(alpha = 0.3f),
    ...
    @Composable
    fun textStyle(): TextStyle = KomrdTheme.typography.label2
}
