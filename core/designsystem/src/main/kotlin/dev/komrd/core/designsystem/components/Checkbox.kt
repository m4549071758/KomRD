...
import dev.komrd.core.designsystem.components.CheckboxDefaults.BoxInDuration
import dev.komrd.core.designsystem.components.CheckboxDefaults.BoxOutDuration
import dev.komrd.core.designsystem.components.CheckboxDefaults.CheckAnimationDuration
import dev.komrd.core.designsystem.components.CheckboxDefaults.CheckboxDefaultPadding
import dev.komrd.core.designsystem.components.CheckboxDefaults.CheckboxSize
import dev.komrd.core.designsystem.components.CheckboxDefaults.MinimumInteractiveSize
import dev.komrd.core.designsystem.components.CheckboxDefaults.RadiusSize
import dev.komrd.core.designsystem.components.CheckboxDefaults.StrokeWidth
...
object CheckboxDefaults {
    ...
    fun colors() =
        CheckboxColors(
            checkedCheckmarkColor = KomrdTheme.colors.onPrimary,
            uncheckedCheckmarkColor = KomrdTheme.colors.transparent,
            checkedBoxColor = KomrdTheme.colors.primary,
            uncheckedBoxColor = KomrdTheme.colors.transparent,
            disabledCheckedBoxColor = KomrdTheme.colors.disabled,
            disabledUncheckedBoxColor = KomrdTheme.colors.transparent,
            disabledIndeterminateBoxColor = KomrdTheme.colors.disabled,
            checkedBorderColor = KomrdTheme.colors.primary,
            uncheckedBorderColor = KomrdTheme.colors.primary,
            disabledBorderColor = KomrdTheme.colors.disabled,
            disabledUncheckedBorderColor = KomrdTheme.colors.disabled,
            disabledIndeterminateBorderColor = KomrdTheme.colors.disabled,
        )
}
            ...
            Row(
                ...
                val customColors =
                    CheckboxColors(
                        ...
                        disabledCheckedBoxColor = KomrdTheme.colors.disabled,
                        disabledUncheckedBoxColor = KomrdTheme.colors.transparent,
                        disabledIndeterminateBoxColor = KomrdTheme.colors.primary,
                        checkedBorderColor = KomrdTheme.colors.primary,
                        uncheckedBorderColor = KomrdTheme.colors.primary,
                        disabledBorderColor = KomrdTheme.colors.disabled,
                        disabledUncheckedBorderColor = KomrdTheme.colors.disabled,
