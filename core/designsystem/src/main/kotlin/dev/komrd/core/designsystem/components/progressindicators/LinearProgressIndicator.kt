package dev.komrd.core.designsystem.components.progressindicators
...
object LinearProgressIndicatorDefaults {
    val Color: Color
        @Composable get() = KomrdTheme.colors.primary

    val TrackColor: Color
        @Composable get() = KomrdTheme.colors.transparent
...
fun LinearProgressIndicatorPreview() {
    KomrdTheme {
        Column(
            ...
            BasicText(text = "Determinate Progress", style = KomrdTheme.typography.body1)
            LinearProgressIndicator(progress = 0.7f)

            BasicText(text = "Indeterminate Progress", style = KomrdTheme.typography.body1)
