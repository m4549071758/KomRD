...
object SliderDefaults {
    @Composable
    fun colors(
        thumbColor: Color = KomrdTheme.colors.primary,
        activeTrackColor: Color = KomrdTheme.colors.primary,
        activeTickColor: Color = KomrdTheme.colors.onPrimary,
        inactiveTrackColor: Color = KomrdTheme.colors.secondary,
        inactiveTickColor: Color = KomrdTheme.colors.primary,
        disabledThumbColor: Color = KomrdTheme.colors.disabled,
        disabledActiveTrackColor: Color = KomrdTheme.colors.disabled,
        disabledActiveTickColor: Color = KomrdTheme.colors.disabled,
        disabledInactiveTrackColor: Color = KomrdTheme.colors.disabled,
    ...
    KomrdTheme {
        Column(
            ...
            Column {
                BasicText(
                    text = "Basic Slider",
                    style = KomrdTheme.typography.h4,
                )
            ...
            Column {
                ...
                Row(
                    ...
                    BasicText(
                        text = "${value.toInt()}",
                        style = KomrdTheme.typography.body1,
                ...
                Slider(
                    ...
                    colors =
                        SliderDefaults.colors(
                            thumbColor = KomrdTheme.colors.error,
                            activeTrackColor = KomrdTheme.colors.error,
                            inactiveTrackColor = KomrdTheme.colors.error.copy(alpha = 0.3f),
                        ),
                    modifier = Modifier.fillMaxWidth(),
                )
            }
