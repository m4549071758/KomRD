...
import dev.komrd.core.designsystem.components.textfield.base.containerUnderline
...
object UnderlinedTextFieldDefaults {
    ...
    fun colors(): TextFieldColors =
        TextFieldColors(
            ...
            focusedContainerColor = KomrdTheme.colors.transparent,
            unfocusedContainerColor = KomrdTheme.colors.transparent,
            disabledContainerColor = KomrdTheme.colors.transparent,
            errorContainerColor = KomrdTheme.colors.transparent,
            cursorColor = KomrdTheme.colors.primary,
            errorCursorColor = KomrdTheme.colors.error,
            textSelectionColors = LocalTextSelectionColors.current,
            focusedOutlineColor = KomrdTheme.colors.primary,
            unfocusedOutlineColor = KomrdTheme.colors.secondary,
