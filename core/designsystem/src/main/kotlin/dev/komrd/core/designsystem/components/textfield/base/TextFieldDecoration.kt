package dev.komrd.core.designsystem.components.textfield.base
...
internal fun CommonDecorationBox(
    ...
    TextFieldTransitionScope.Transition(
        ...
        val decoratedLabel: @Composable (() -> Unit)? =
            label?.let {
                @Composable {
                    Decoration(labelColor, KomrdTheme.typography.label1, it)
                }
            }
                ...
                @Composable { modifier ->
                    Box(modifier.alpha(placeholderAlphaProgress)) {
                        Decoration(
                            ...
                            typography = KomrdTheme.typography.input,
                            content = placeholder,
                        )
                    }
                }
        ...
        val decoratedSupporting: @Composable (() -> Unit)? =
            supportingText?.let {
                @Composable {
                    Decoration(contentColor = supportingTextColor, typography = KomrdTheme.typography.body2, content = it)
                }
            }
