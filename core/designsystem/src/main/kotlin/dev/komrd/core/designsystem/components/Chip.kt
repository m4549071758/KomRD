...
import dev.komrd.core.designsystem.components.ChipDefaults.ChipIconHorizontalPadding
import dev.komrd.core.designsystem.components.ChipDefaults.ChipIconSize
import dev.komrd.core.designsystem.components.ChipDefaults.ChipRectShape
...
internal object ChipDefaults {
    ...
    fun primaryFilled(shape: Shape) =
        ChipStyle(
            colors =
                ChipColors(
                    containerColor = KomrdTheme.colors.surface,
                    contentColor = KomrdTheme.colors.onSurface,
                    selectedContainerColor = KomrdTheme.colors.primary,
                    selectedContentColor = KomrdTheme.colors.onPrimary,
        ...
        ChipStyle(
            colors =
                ChipColors(
                    ...
                    outlineColor = KomrdTheme.colors.primary,
                    selectedContainerColor = KomrdTheme.colors.primary,
                    selectedOutlineColor = KomrdTheme.colors.primary,
                    selectedContentColor = KomrdTheme.colors.onPrimary,
                    disabledContainerColor = KomrdTheme.colors.transparent,
                    disabledContentColor = KomrdTheme.colors.onDisabled,
                    disabledOutlineColor = KomrdTheme.colors.disabled,
                ),
            shape = shape,
            elevation = null,
            contentPadding = contentPadding,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Chip {
                    Row(
                        ...
                        BasicText("Chip", style = KomrdTheme.typography.label3)
                    }
                }
