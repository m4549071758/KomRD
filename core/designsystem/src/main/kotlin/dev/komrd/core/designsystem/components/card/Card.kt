package dev.komrd.core.designsystem.components.card
...
import dev.komrd.core.designsystem.LocalTypography
...
object CardDefaults {
    ...
    fun cardColors(
        ...
        contentColor: Color = KomrdTheme.colors.onSurface,
        disabledContainerColor: Color =
            KomrdTheme.colors.disabled,
        disabledContentColor: Color = KomrdTheme.colors.onDisabled,
    ): CardColors =
        CardColors(
    ...
    fun elevatedCardColors(
        ...
        contentColor: Color = KomrdTheme.colors.onBackground,
        disabledContainerColor: Color =
            KomrdTheme.colors.disabled,
        disabledContentColor: Color = KomrdTheme.colors.onDisabled,
    ): CardColors =
