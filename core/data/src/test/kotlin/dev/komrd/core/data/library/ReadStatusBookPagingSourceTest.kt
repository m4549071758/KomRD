...
class ReadStatusBookPagingSourceTest {
    ...
    private fun source(): ReadStatusBookPagingSource {
        val srv =
            Server(
                id = "s1",
                name = "Home",
        ...
        return ReadStatusBookPagingSource(
            client = factory.clientFor(srv),
            server = srv,
            readStatus = "IN_PROGRESS",
            sort = LibraryRepository.DEFAULT_READ_STATUS_SORT,
