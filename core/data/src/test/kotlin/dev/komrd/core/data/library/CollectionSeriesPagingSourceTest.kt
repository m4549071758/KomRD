...
class CollectionSeriesPagingSourceTest {
    ...
    @Test
    fun load_success_mapsToDomain_andHitsCollectionSeriesPath() =
        runTest {
            ...
            assertEquals("/api/v1/collections/c1/series", server.takeRequest().url.encodedPath)
    ...
    private fun source(): CollectionSeriesPagingSource {
        val srv =
            Server(
                id = "s1",
                name = "Home",
        ...
        return CollectionSeriesPagingSource(
