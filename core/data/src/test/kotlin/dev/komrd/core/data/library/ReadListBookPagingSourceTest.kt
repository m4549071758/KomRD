...
class ReadListBookPagingSourceTest {
    ...
    @Test
    fun load_success_mapsToDomain_andHitsReadListBooksPath() =
        runTest {
            ...
            assertEquals("/api/v1/readlists/r1/books", server.takeRequest().url.encodedPath)
    ...
    private fun source(): ReadListBookPagingSource {
        val srv =
            Server(
                id = "s1",
                name = "Home",
        ...
        return ReadListBookPagingSource(
